            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildStatRow('Off', '$offDays', AppTheme.warning),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildStatRow('Off', '$offLectures', AppTheme.warning),
                  _buildStatRow('Attendance', '${attendancePercentage.toStringAsFixed(1)}%', AppTheme.primary),
                ],
              ),
            ),
          ],
